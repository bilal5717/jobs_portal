...
(function (root, factory) {
  ...
  var Plugin = function (questions, opts) {
    ...
    publicAPIs.init = function (questions, options) {
      ...
      if (!isElement(settings.wrapper)) throw new TypeError('Please select a valid quiz wrapper.');
    ...
    publicAPIs.addQuestion = function (question, answers, correctAnswer) {
      ...
      if (!Array.isArray(answers)) throw new TypeError('Answers must be array.');
    ...
    */
    publicAPIs.setup = function () {
      ...
      var template = '<div class="ysquiz-content"><div class="ysquiz-question"></div></div>';
