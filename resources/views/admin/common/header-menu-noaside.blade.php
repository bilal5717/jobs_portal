        	...
        	<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
        		<div class="header-logo" style="margin-top: 5px; ">
					<a href="{{config('app.wp_url', '/')}}">
						<img alt="Logo" width="160" src="{{asset('public/media/logos/logo.png')}}" class="h-30px">
					</a>
				</div>
        	</div>
				...
				<div class="kt-header__topbar-item kt-header__topbar-item--user">
					<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
						<div class="kt-header__topbar-user">
							...
							<span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold"  style="text-transform: capitalize;">{{@substr(Auth::guard('admin')->user()->name, 0, 1)}}</span>
						</div>
					</div>
