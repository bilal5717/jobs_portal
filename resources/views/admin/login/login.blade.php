	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v3 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(public/media/bg/bg-3.jpg);">
						...
						<div class="kt-login__container">
							...
							@if(isset($data['type']) && $data['type'] =='user')         
							    <div class="row">
									...
									<span>Already logged in as user type <u>{{$data['email']}}</u>.</span> <br />
									<span>Please <u><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout </a></u> the exising user.</span>-->
							...
							<div class="kt-login__signin">
								...
								<form id="form" data-parsley-validate class="kt-form" method="POST" action="{{ route('login') }}">
                                    @csrf
									...
									<div class="input-group">
										<input class="form-control" type="password" placeholder="Password" name="password" required data-parsley-maxlength="16" data-parsley-minlength="8" data-parsley-trigger="change">
									</div>
